"""Service for parsing and building validation rules from AI responses."""
...
class RuleBuilder:
    """Parses AI responses and builds Rule objects."""
    ...
    def parse_rules(self, ai_response: str) -> list[Rule]:
        ...
        logger.info(
            "Successfully parsed %d rules from AI response",
            len(rules)
        )
        return rules
